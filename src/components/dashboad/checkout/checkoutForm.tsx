...
import { Button, ButtonGroup, CircularProgress, Divider, TextField } from "@mui/material";
...
export const CheckoutForm = ({ message, setMessage }: Props): JSX.Element => {
  ...
  console.log(additionalInfo,cardHolderName,"cardHolderName additionalInfo additionalInfoadditionalInfo")
