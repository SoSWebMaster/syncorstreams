...
import { updatePageNameId, updatePlayListFilter, updatePlayLists } from '../../../store/music-store';
...
const PlayListCard: React.FC<PlayListCardProps> = ({openState, onSelect, onClose }) => {
    ...
    return  (
        <div className="flex flex-wrap mx-5 gap-x-5 gap-y-5">
            {
            isCircularLoading ?  (<CircularProgress size={40} className='!text-[#FB8A2E]'/>):
